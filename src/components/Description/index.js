...
const Description = () => (
    <div id="description">
        <div id="description-text">
            ...
            <div id="description-text-icons">
                <a href="www.linkedin.com/in/jeremie-aubeau"><Icon name="linkedin" size="big" /></a>
                <a href="#"><Icon name="file alternate outline" size="big" /></a>
            </div>
        </div>
